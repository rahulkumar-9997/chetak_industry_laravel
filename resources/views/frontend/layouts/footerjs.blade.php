<!-- JS here -->
<script src="{{asset('fronted/js/vendor/modernizr-3.5.0.min.js')}}"></script>
<script src="{{asset('fronted/js/vendor/jquery-1.12.4.min.js')}}"></script>
<script src="{{asset('fronted/js/popper.min.js')}}"></script>
<script src="{{asset('fronted/js/bootstrap.min.js')}}"></script>
<script src="{{asset('fronted/js/one-page-nav-min.js')}}"></script>
...
<script src="{{asset('fronted/js/imagesloaded.min.js')}}"></script>
<script src="{{asset('fronted/js/jquery.meanmenu.min.js')}}"></script>
